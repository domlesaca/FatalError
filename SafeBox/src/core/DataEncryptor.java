...
class DataEncryptor {
	...
	/**
	 * @param data
	 *            the object that was previously encrypted by dataEncryptor
	 * @param password
	 *            the password used to encrypt
	 * @param salt
	 *            the salt used to encrypt the data
	 * @return the decrypted data
	 * @throws Exception
	 *             if an error occurred decrypting
	 */
	...
	public static void main(String[] args) { // just testing here
		try {
			...
			System.out.println(new String(decryptData(encryptedDataObject, password, salt))); // this
																								// should
																								// work
			System.out.println(new String(decryptData(encryptedDataObject, "ThisIsNotMyPassword".toCharArray(), salt))); // this
																															// should
																															// fail
