...
public class EncryptedStorageManager {
	...
	/**
	 * @param password
	 *            the password to be used for future encryption/decryption
	 */
	...
	/**
	 * @return true if a FileSystemHandler has been saved before, otherwise
	 *         false
	 */
	 ...
	 * @return true if passwordToTest equals the current password, false
	 *         otherwise. Note that the current password is the password in
	 *         memory, NOT the password on the filesystem
	 */
	...
	public static void main(String[] args) {
		...
		FileSystemHandler fsh = eSM.getFileSystemHandler(); // this gets the
															// actual saved
															// FileSystemhandler
															// object
		...
		Node tempNode = fsh.createFolder(fsh.getRoot(), "test folder"); // change
																		// something
																		// here
		...
		// eSM.saveFileSystemHandler(); // save the FileSystemHandler to the
		// disk
