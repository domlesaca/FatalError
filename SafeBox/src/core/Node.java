...
public class Node implements Serializable {
	...
	// Constructor Initializes a new node containing the folder/record f , with
	// it's parent = p, without any children
	...
	/**
	 * @param child
	 *            the node added as a child of the current node
	 */
	...
	/**
	 * @param index
	 *            the spot where a child node is
	 */
	...
	/**
	 * @return a multi-line, indented representation of the tree, starting at
	 *         this node
	 */
	...
	/**
	 * @param depth
	 *            the number of indents to place before a row, will be
	...
	// return "[name=" + getData().getName() + ", localIndex=" + getLocalIndex()
	// + ", globaIndex=" + getGlobalIndex() + ", children.size()=" +
	// getChildren().size() + "]";
	// }
