...
class SerializationUtils {
	...
	/**
	 * @param obj
	 *            the object being turned to a byte array
	...
	public static void main(String[] args) {
		HashMap<String, String> testHashMap = new HashMap<String, String>(); // set
																				// up
																				// a
																				// new
																				// hash
		...
		byte[] testHashMapSerialized = objectToByteArray(testHashMap); // Serialize
																		// it.
																		// At
																		// this
																		// point,
		...
		testHashMap.clear(); // Kill the original hash map. This is what would
								// happen when we close the program
		testHashMap = null;

		Object reconstructedHashMap = byteArrayToObject(testHashMapSerialized); // reconstruct
																				// the
																				// object
																				// from
																				// the
		...
		if (reconstructedHashMap instanceof HashMap) { // make sure the object
														// is a HashMap
			System.out.println(reconstructedHashMap.toString()); // do something
																	// with it
		} else {
